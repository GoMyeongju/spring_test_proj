...
public class SampleDAOSpring implements SampleDAO {
	...
	private final String SAMPLE_UPDATE = "UPDATE SAMPLE SET TITLE=?, REG_USER=?, CONTENT=? WAHERE ID=?";
	...
	public List<SampleVO> selectSampleList(SampleVO vo) throws Exception {
		System.out.println("===> Spring으로 selectSamplList() 기능 처리");
